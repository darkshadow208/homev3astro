...
const imgLCP = new Proxy({"src":"/_astro/fotografia.5pLDIJT3.webp","width":4096,"height":2730,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const optimizedLCP = await getImage({ src: imgLCP, width: 800, quality: 80, format: "webp" });
...
const imgQuinceanos = new Proxy({"src":"/_astro/fiesta-quince.D5N76TlV.webp","width":4096,"height":2730,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imgGastronomia = new Proxy({"src":"/_astro/gastronomia.Qkqk32jW.webp","width":4096,"height":2747,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imgEnvigado = new Proxy({"src":"/_astro/Montview.rlyTY66U.jpeg","width":1280,"height":854,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/Montview.jpeg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/Montview.jpeg");
							return target[name];
						}
					});

const imgBodas = new Proxy({"src":"/_astro/bodas.ClQxCZD5.webp","width":4096,"height":2731,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imgBannerMomentos = new Proxy({"src":"/_astro/recurso-12-81.BJKlMFFq.webp","width":1913,"height":1275,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/recurso-12-81.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/recurso-12-81.webp");
							return target[name];
						}
					});

const imgBannerBodas = new Proxy({"src":"/_astro/banner-bodas-slide.CrKHgQkQ.avif","width":4176,"height":2784,"format":"avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/banner-bodas-slide.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/banner-bodas-slide.avif");
							return target[name];
						}
					});

const imgBannerDomicilios = new Proxy({"src":"/_astro/catering.CtCCI1v7.webp","width":6719,"height":4073,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/catering.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/catering.webp");
							return target[name];
						}
					});

const imgQuinceGRN = new Proxy({"src":"/_astro/GRN2683.BrGD7SHn.webp","width":3000,"height":2000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/GRN2683.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/GRN2683.webp");
							return target[name];
						}
					});

const $$Banner = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="w-[calc(100%-8px)]  md:w-[calc(100%-16px)] max-w-[2000px] h-[650px] md:h-[800px] relative rounded-[2rem] md:rounded-[3rem] overflow-hidden mx-auto" data-astro-cid-kggsjsm4> <div class="swiper mySwiper w-full h-full" data-astro-cid-kggsjsm4> <div class="swiper-wrapper" data-astro-cid-kggsjsm4> <!-- Momentos para toda la vida --> <div class="swiper-slide relative" data-astro-cid-kggsjsm4> ${renderComponent($$result, "Image", $$Image, { "src": imgBannerMomentos, "class": "absolute inset-0 w-full h-full object-cover", "style": "object-position: center 85%;", "alt": "Momentos para toda la vida", "loading": "eager", "fetchpriority": "high", "width": 1600, "height": 900, "widths": [480, 768, 1024, 1280, 1600], "sizes": "(max-width: 768px) 100vw, 1600px", "format": "avif", "quality": 65, "data-astro-cid-kggsjsm4": true })} <!-- <div class="absolute inset-0 bg-black/30"></div> --> <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 pb-24 md:pb-20" data-astro-cid-kggsjsm4> <h1 class="text-3xl md:text-5xl lg:text-6xl font-medium text-white drop-shadow-lg leading-tight" data-astro-cid-kggsjsm4>
...
Agenda una asesoría
</a> </div> </div> <div class="swiper-slide relative" data-astro-cid-kggsjsm4> ${renderComponent($$result, "Image", $$Image, { "src": imgQuinceanos, "class": "absolute inset-0 w-full h-full object-cover", "style": "object-position: center 15%;", "alt": "Fiesta de Quincea\xF1os", "loading": "lazy", "width": 1600, "height": 900, "widths": [480, 768, 1024, 1280, 1600], "sizes": "(max-width: 768px) 100vw, 1600px", "format": "avif", "quality": 65, "decoding": "async", "data-astro-cid-kggsjsm4": true })} <!-- <div class="absolute inset-0 bg-black/40"></div> --> <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 pb-24 md:pb-20" data-astro-cid-kggsjsm4> <h1 class="text-4xl md:text-7xl text-white drop-shadow-lg" data-astro-cid-kggsjsm4>
Fiesta de quince años
</h1> <br data-astro-cid-kggsjsm4> <a href="https://wa.me/573168753305?text=Hola!" class="action-btn w-full md:w-auto" data-astro-cid-kggsjsm4>
Agenda una asesoría
</a> </div> </div> <!-- Fiesta de quince años (GRN) --> <div class="swiper-slide relative" data-astro-cid-kggsjsm4> ${renderComponent($$result, "Image", $$Image, { "src": imgQuinceGRN, "class": "absolute inset-0 w-full h-full object-cover", "style": "object-position: center 15%;", "alt": "Fiesta de quince a\xF1os", "loading": "lazy", "width": 1600, "height": 900, "widths": [480, 768, 1024, 1280, 1600], "sizes": "(max-width: 768px) 100vw, 1600px", "format": "avif", "quality": 65, "decoding": "async", "data-astro-cid-kggsjsm4": true })} <!-- <div class="absolute inset-0 bg-black/40"></div> --> <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 pb-24 md:pb-20" data-astro-cid-kggsjsm4> <h1 class="text-4xl md:text-7xl text-white drop-shadow-lg" data-astro-cid-kggsjsm4>
Fiesta de 15 años
</h1> <br data-astro-cid-kggsjsm4> <a href="https://wa.me/573168753305?text=Hola!" class="action-btn w-full md:w-auto" data-astro-cid-kggsjsm4>
Agenda una asesoría
</a> </div> </div> <!-- Gastronomía --> <div class="swiper-slide relative" data-astro-cid-kggsjsm4> ${renderComponent($$result, "Image", $$Image, { "src": imgGastronomia, "class": "absolute inset-0 w-full h-full object-cover", "style": "object-position: center 15%;", "alt": "Gastronom\xEDa", "loading": "lazy", "width": 1600, "height": 900, "widths": [480, 768, 1024, 1280, 1600], "sizes": "(max-width: 768px) 100vw, 1600px", "format": "avif", "quality": 65, "decoding": "async", "data-astro-cid-kggsjsm4": true })} <!-- <div class="absolute inset-0 bg-black/40"></div> --> <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 pb-24 md:pb-20" data-astro-cid-kggsjsm4> <h1 class="text-4xl md:text-7xl text-white drop-shadow-lg" data-astro-cid-kggsjsm4>
Gastronomía
</h1> <br data-astro-cid-kggsjsm4> <a href="https://wa.me/573168753305?text=Hola!" class="action-btn w-full md:w-auto" data-astro-cid-kggsjsm4>
Agenda una asesoría
</a> </div> </div> <!-- Lugares para eventos --> <div class="swiper-slide relative" data-astro-cid-kggsjsm4> ${renderComponent($$result, "Image", $$Image, { "src": imgEnvigado, "class": "absolute inset-0 w-full h-full object-cover", "style": "object-position: center 15%;", "alt": "Lugares para eventos", "loading": "lazy", "width": 1600, "height": 900, "widths": [480, 768, 1024, 1280, 1600], "sizes": "(max-width: 768px) 100vw, 1600px", "format": "avif", "quality": 65, "decoding": "async", "data-astro-cid-kggsjsm4": true })} <!-- <div class="absolute inset-0 bg-black/40"></div> --> <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 pb-24 md:pb-20" data-astro-cid-kggsjsm4> <h1 class="text-4xl md:text-7xl text-white drop-shadow-lg" data-astro-cid-kggsjsm4>
Lugares para eventos
</h1> <br data-astro-cid-kggsjsm4> <a href="https://wa.me/573168753305?text=Hola!" class="action-btn w-full md:w-auto" data-astro-cid-kggsjsm4>
Agenda una asesoría
</a> </div> </div> <!-- Fotografía --> <div class="swiper-slide relative" data-astro-cid-kggsjsm4> ${renderComponent($$result, "Image", $$Image, { "src": imgBodas, "class": "absolute inset-0 w-full h-full object-cover", "style": "object-position: center 75%;", "alt": "Fotograf\xEDa", "loading": "lazy", "width": 1600, "height": 900, "widths": [480, 768, 1024, 1280, 1600], "sizes": "(max-width: 768px) 100vw, 1600px", "format": "avif", "quality": 65, "decoding": "async", "data-astro-cid-kggsjsm4": true })} <!-- <div class="absolute inset-0 bg-black/40"></div> --> <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 pb-24 md:pb-20" data-astro-cid-kggsjsm4> <h1 class="text-4xl md:text-7xl text-white drop-shadow-lg" data-astro-cid-kggsjsm4>
Galeria
</h1> <br data-astro-cid-kggsjsm4> <a href="https://wa.me/573168753305?text=Hola!" class="action-btn w-full md:w-auto" data-astro-cid-kggsjsm4>
Agenda una asesoría
</a> </div> </div> <!-- Bodas --> <div class="swiper-slide relative" data-astro-cid-kggsjsm4> ${renderComponent($$result, "Image", $$Image, { "src": imgBannerBodas, "class": "absolute inset-0 w-full h-full object-cover", "style": "object-position: center 15%;", "alt": "Bodas", "loading": "lazy", "width": 1600, "height": 900, "widths": [480, 768, 1024, 1280, 1600], "sizes": "(max-width: 768px) 100vw, 1600px", "format": "avif", "quality": 65, "decoding": "async", "data-astro-cid-kggsjsm4": true })} <!-- <div class="absolute inset-0 bg-black/40"></div> --> <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 pb-24 md:pb-20" data-astro-cid-kggsjsm4> <h1 class="text-4xl md:text-7xl text-white drop-shadow-lg" data-astro-cid-kggsjsm4>
Bodas
</h1> <br data-astro-cid-kggsjsm4> <a href="https://wa.me/573168753305?text=Hola!" class="action-btn w-full md:w-auto" data-astro-cid-kggsjsm4>
Agenda una asesoría
</a> </div> </div> <!-- Catering--> <div class="swiper-slide relative" data-astro-cid-kggsjsm4> ${renderComponent($$result, "Image", $$Image, { "src": imgBannerDomicilios, "class": "absolute inset-0 w-full h-full object-cover", "style": "object-position: center 15%;", "alt": "Domicilios", "loading": "lazy", "width": 1600, "height": 900, "widths": [480, 768, 1024, 1280, 1600], "sizes": "(max-width: 768px) 100vw, 1600px", "format": "avif", "quality": 65, "decoding": "async", "data-astro-cid-kggsjsm4": true })} <!-- <div class="absolute inset-0 bg-black/40"></div> --> <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 pb-24 md:pb-20" data-astro-cid-kggsjsm4> <!-- Title smaller as requested --> <h2 class="text-3xl md:text-5xl text-white drop-shadow-lg font-medium" data-astro-cid-kggsjsm4>
Catering
</h2> <br data-astro-cid-kggsjsm4> <a href="https://wa.me/573168753305?text=Hola!" class="action-btn w-full md:w-auto" data-astro-cid-kggsjsm4>
Agenda una asesoría
</a> </div> </div> </div> <!-- Navigation Arrows --> <div class="swiper-button-prev-banner absolute left-2 md:left-8 top-1/2 -translate-y-1/2 z-50 text-white/70 hover:text-white cursor-pointer transition-all hover:scale-110" data-astro-cid-kggsjsm4> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-kggsjsm4><path d="m15 18-6-6 6-6" data-astro-cid-kggsjsm4></path></svg> </div> <div class="swiper-button-next-banner absolute right-2 md:right-8 top-1/2 -translate-y-1/2 z-50 text-white/70 hover:text-white cursor-pointer transition-all hover:scale-110" data-astro-cid-kggsjsm4> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-kggsjsm4><path d="m9 18 6-6-6-6" data-astro-cid-kggsjsm4></path></svg> </div> </div> <div class="absolute top-0 left-0 right-0 z-30 w-full px-4 py-8 md:px-12 md:py-10 flex flex-col md:flex-row items-center justify-between gap-5 bg-gradient-to-b from-black/80 via-black/40 to-transparent" data-astro-cid-kggsjsm4> <div class="hidden md:flex flex-1 justify-start gap-8 pb-3 items-center" data-astro-cid-kggsjsm4> <a href="https://www.tusanagustin.com/" class="nav-text-link" data-astro-cid-kggsjsm4>Inicio</a> <!-- Eventos Dropdown --> <div class="relative group" data-astro-cid-kggsjsm4> <button class="nav-text-link flex items-center gap-1 focus:outline-none" data-astro-cid-kggsjsm4>
Eventos
...
const imgAdriana = new Proxy({"src":"/_astro/planner-adriana.BR7EYQYq.webp","width":2730,"height":4096,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imgQuince = new Proxy({"src":"/_astro/quince.HTovlSy5.webp","width":4096,"height":2725,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imgCelebraciones = new Proxy({"src":"/_astro/home-18.BAWoVjUh.webp","width":2450,"height":1636,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/home-18.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/home-18.webp");
							return target[name];
						}
					});
...
const iconFb = new Proxy({"src":"/_astro/Facebook.BK6UR8KJ.webp","width":16,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/Facebook.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/Facebook.webp");
							return target[name];
						}
					});
...
const iconIg = new Proxy({"src":"/_astro/Instagram.kjCPTWja.webp","width":28,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/Instagram.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/Instagram.webp");
							return target[name];
						}
					});
...
const iconTk = new Proxy({"src":"/_astro/TikTock.B63molJW.webp","width":25,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/TikTock.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/TikTock.webp");
							return target[name];
						}
					});
...
const iconLi = new Proxy({"src":"/_astro/Link.DdrVHlIV.webp","width":30,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/Link.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/Link.webp");
							return target[name];
						}
					});
...
const iconYt = new Proxy({"src":"/_astro/Youtube.D-jMaSlS.webp","width":40,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/Youtube.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/Youtube.webp");
							return target[name];
						}
					});
...
const iconWa = new Proxy({"src":"/_astro/Whatsapp.BjEMeso6.webp","width":28,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/Whatsapp.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/Whatsapp.webp");
							return target[name];
						}
					});
...
const logoVerde = new Proxy({"src":"/_astro/LogoSanAgustínGris.C3VFR1cj.webp","width":126,"height":66,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/LogoSanAgustínGris.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/LogoSanAgustínGris.webp");
							return target[name];
						}
					});
...
const iconPh = new Proxy({"src":"/_astro/Telefono.D3SvoQZb.webp","width":38,"height":40,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/Telefono.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/Telefono.webp");
							return target[name];
						}
					});
...
const imgEmpresarialesUnique = new Proxy({"src":"/_astro/0j8a0641.C6SUdvSq.webp","width":2302,"height":1534,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imgMedellin = new Proxy({"src":"/_astro/6CED1B6E-E6A6-42B3-982B-814ED01A55AC-_1_.DDezl_v_.webp","width":3213,"height":5712,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/6CED1B6E-E6A6-42B3-982B-814ED01A55AC-_1_.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/6CED1B6E-E6A6-42B3-982B-814ED01A55AC-_1_.webp");
							return target[name];
						}
					});
...
const imgDisney = new Proxy({"src":"/_astro/disney-castle.BaDgAYcf.webp","width":1428,"height":1785,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imgBeach = new Proxy({"src":"/_astro/beach-wedding.CBTEMC3f.webp","width":2730,"height":4096,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imgCruise = new Proxy({"src":"/_astro/cruise-ship.D9ArcrQM.webp","width":2730,"height":4096,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imgBlog1 = new Proxy({"src":"/_astro/DSC_6916-_1_.BNdS0Jlq.webp","width":6048,"height":4024,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/DSC_6916-_1_.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/DSC_6916-_1_.webp");
							return target[name];
						}
					});

const imgBlog2 = new Proxy({"src":"/_astro/MPYV9834.-5okAYcO.webp","width":6014,"height":4009,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/MPYV9834.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/MPYV9834.webp");
							return target[name];
						}
					});
...
const iconPi = new Proxy({"src":"/_astro/Pinterest _1.80luK4it.webp","width":22,"height":28,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/Pinterest _1.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/Pinterest _1.webp");
							return target[name];
						}
					});
...
const award11 = new Proxy({"src":"/_astro/diseño-sin-título-10.DeXZggfe.webp","width":1080,"height":1350,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/diseño-sin-título-10.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/diseño-sin-título-10.webp");
							return target[name];
						}
					});
...
const award12 = new Proxy({"src":"/_astro/diseño-sin-título-2.Do--M1qd.webp","width":1080,"height":1350,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/homev3/src/assets/images/diseño-sin-título-2.webp";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("E:/homev3/src/assets/images/diseño-sin-título-2.webp");
							return target[name];
						}
					});
